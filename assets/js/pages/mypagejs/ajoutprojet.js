...
var BaseFormWizard = function() {
    ...
    var initWizardValidation = function(){
        ...
        var $validator2 = $form2.validate({
            ...
            messages: {
                 'tridept': {
                    required: 'Veuillez saisir le trigramme département',
                ...
                'dep': 'Veuillez choisir le département',
                'id_nro': 'Veuillez choisir le nro',
                'taille': 'Veuillez saisir la taille',
                'date_mad_site_origine':'La date est obligatoire'
